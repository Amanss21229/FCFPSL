...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "features.material.title": "NEET/JEE Ready",
    "features.material.desc": "Complete Chemistry for 11th, 12th & Droppers (Organic, Inorganic, Physical) for competitive exams.",
  ...
  hi: {
    ...
    "features.material.title": "NEET/JEE की तैयारी",
    "features.material.desc": "11वीं, 12वीं और ड्रॉपर के लिए पूरी केमिस्ट्री (ऑर्गेनिक, इनऑर्गेनिक, फिजिकल) प्रतियोगी परीक्षाओं के लिए।",
