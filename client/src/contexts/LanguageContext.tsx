...
const translations: Record<Language, Record<string, string>> = {
  en: {
    "announcement.text": "🎉 Session 2026-27 Admission Open  •  Classes Start 23 March 2026  •  Admission is FREE — Seats Are Limited, Register Now!",
    "admission.badge": "Session 2026-27 — Now Enrolling",
    "admission.classes.start": "Classes Start: 23 March 2026",
    "admission.free": "Admission FREE",
    "admission.seats": "Limited Seats — Register Today!",
    "hero.badge": "Session 2026-27 Admission Open — FREE",
    "hero.title1": "Sansa Learn",
    "hero.title2": "Offline Coaching",
    "hero.subtitle": "Session 2026-27 is LIVE! Classes begin 23 March 2026. Register FREE for Class 4th–12th, NEET & JEE.",
  ...
  hi: {
    "announcement.text": "🎉 सत्र 2026-27 का एडमिशन शुरू  •  23 मार्च 2026 से क्लासेस शुरू  •  एडमिशन बिल्कुल FREE — सीटें सीमित हैं, अभी रजिस्टर करें!",
    "admission.badge": "सत्र 2026-27 — एडमिशन जारी",
    "admission.classes.start": "क्लासेस शुरू: 23 मार्च 2026",
    "admission.free": "एडमिशन बिल्कुल FREE",
    "admission.seats": "सीटें सीमित — आज ही रजिस्टर करें!",
    "hero.badge": "सत्र 2026-27 एडमिशन शुरू — बिल्कुल FREE",
    "hero.title1": "सांसा लर्न",
    "hero.title2": "ऑफलाइन कोचिंग",
    "hero.subtitle": "सत्र 2026-27 LIVE है! 23 मार्च 2026 से क्लासेस शुरू। कक्षा 4-12, NEET और JEE के लिए FREE रजिस्टर करें।",
